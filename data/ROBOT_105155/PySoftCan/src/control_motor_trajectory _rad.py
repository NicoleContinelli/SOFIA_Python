...
def plot_two_function(title, t, y1_1, y1_2, y2_1, y2_2, color1, color2, label1, label2, label3):
    ...
    plt.legend()
    plt.savefig('MLP_paper_robot_trajectory_pos_rad_v3.png')
    return plt.show()
...
# Model trained
model_reg = joblib.load('.../ml_models/trained_error_motors_rad.pkl')
...
df.to_csv('/home/sofia/SOFIA_Python/data/Data_2025/Data_Paper_Robotics/trajectory_pos_rad_v3.csv', index=False)

plot_two_function("Control de trayectoria en lazo cerrado de la Cinemática Inversa - MLP datos en escala de radianes",time_data,
