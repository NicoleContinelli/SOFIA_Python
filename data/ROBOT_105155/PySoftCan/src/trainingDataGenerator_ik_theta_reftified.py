...
df1_10 = pd.read_csv('.../ROBOT_105155/data/data_february_2023/data_orient10_MASTER_24.csv')
...
df_training.to_csv(
        '.../ROBOT_105155/data/data_february_2023/data_training_orient10_MASTER_24.csv', index=False)
