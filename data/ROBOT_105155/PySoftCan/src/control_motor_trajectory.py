...
# Model trained
model_reg = joblib.load('.../ml_models/trained_error_motors_output_dist.pkl')
...
df.to_csv('/home/sofia/SOFIA_Python/data/Data_2025/Data_Paper_Robotics/trajectory_pos_recta.csv', index=False)
