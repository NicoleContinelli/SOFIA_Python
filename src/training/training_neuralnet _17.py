...
# neural network
neuronas = 25
h_layer_1 = tf.keras.layers.Dense(
    units=neuronas, input_shape=[2], activation=tf.nn.elu)
...
trained_model_17 = model_17.fit(X_train, y_train, epochs=5)
