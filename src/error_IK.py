...
data_IK = pd.read_csv('/home/sofia/SOFIA_Python/data/Data_2022/data_november/data_orient10_v2.csv')
...
data_error.to_csv('/home/sofia/SOFIA_Python/data/Data_2022/data_november/data_error_orient10_v2.csv', index = False)
