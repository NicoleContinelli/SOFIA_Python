...
# Model trained
model_m1 = joblib.load('/home/sofia/SOFIA_Python/ml/TFM/trained_error_motors_MASTER_V5_motor1.pkl')
model_m2 = joblib.load('/home/sofia/SOFIA_Python/ml/TFM/trained_error_motors_MASTER_V5_motor2.pkl')
model_m3 = joblib.load('/home/sofia/SOFIA_Python/ml/TFM/trained_error_motors_MASTER_V5_motor3.pkl')
...
for step in np.arange(0,10,0.05):
    ...
    pred_m1 = model_m1.predict(values_to_predict_trans)
    pred_m2 = model_m2.predict(values_to_predict_trans)
    pred_m3 = model_m3.predict(values_to_predict_trans)

    #pred = pred.flatten().tolist()
    pred_m1 = pred_m1.flatten().tolist()
    pred_m2 = pred_m2.flatten().tolist()
    pred_m3 = pred_m3.flatten().tolist()

    error_theta1 = pred_m1[0] # Grab the values of theta for each motor
    error_theta2 = pred_m2[0]
    error_theta3 = pred_m3[0]
