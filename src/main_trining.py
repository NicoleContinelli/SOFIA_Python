...
#ML
model_reg = joblib.load('/home/sofia/SOFIA_Python/ml/trained_model3.pkl')
...
# Orientation's repetition
    ...
    #print(df)
    df.to_csv('/home/sofia/SOFIA_Python/data/data_september/data_model2_reg_NN1TAHN.csv', index = False)
    df.info()
