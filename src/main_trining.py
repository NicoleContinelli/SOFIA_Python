...
#ML
model_reg = joblib.load('/home/sofia/SOFIA_Python/ml/trained_model15_reg_NN1.pkl')
...
# Orientation's repetition
    ...
    #print(df)
    df.to_csv('/home/sofia/SOFIA_Python/data/data_august/data_model15_NN1.csv', index = False)
    df.info()
