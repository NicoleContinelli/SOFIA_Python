...
# Motors
motors = SystemMotors(1)  # instantiate SystemMotors class >> number of motors >> OJO CHANGE IT DEPENDING ON THE # OF MOTORS
motors.loadMotors([33], "SoftArmMotorConfig.json")  # motor's ids
