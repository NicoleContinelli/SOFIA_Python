...
class SocketCanPort(PortBase.PortBase):
    ...
    def __init__(self, *args):
        _SocketCanPort.SocketCanPort_swiginit(self, _SocketCanPort.new_SocketCanPort(*args))
...
# Register SocketCanPort in _SocketCanPort:
_SocketCanPort.SocketCanPort_swigregister(SocketCanPort)
